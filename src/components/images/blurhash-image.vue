...
export default defineComponent({
  ...
  setup(properties) {
    ...
    const hash = computed(() => {
      return getImageInfo(properties.item, {
        preferThumb: properties.type === ImageTypeEnum.Thumb,
        preferBanner: properties.type === ImageTypeEnum.Banner,
        preferLogo: properties.type === ImageTypeEnum.Logo,
        preferBackdrop: properties.type === ImageTypeEnum.Backdrop
      }).blurhash;
    });
    ...
    const getImage = () => {
      nextTick(() => {
        if (imageElement.value) {
          const imageInfo = getImageInfo(properties.item, {
            preferThumb: properties.type === ImageTypeEnum.Thumb,
            preferBanner: properties.type === ImageTypeEnum.Banner,
            preferLogo: properties.type === ImageTypeEnum.Logo,
            preferBackdrop: properties.type === ImageTypeEnum.Backdrop,
    ...
    return { getItemIcon, error, hash, loading, image, onError };
  }
});
</script>
